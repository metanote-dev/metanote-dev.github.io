...
* 0.7.1
Black Friday! Enjoy a 50% discount on the permanent purchase of Metanote, available globally from November 24th to 27th. Don't miss out on this exclusive offer. Upgrade now!
...
In addition, in order for users to fully utilize the powerful features of Metanote and Org mode, we have updated and maintained some documents and tutorials at [[https://github.com/metanote-dev/metanote-dev.github.io/wiki]]. Please refer to them.
* 0.7.0
